...
protected:
    ...
    simple_graph::ListGraph<true, std::pair<float, float>, float> directed_graph;
};
...
static float dist(const simple_graph::ListGraph<true, std::pair<float, float>, float> &g,
        vertex_index_t c, vertex_index_t r)
{
    const auto &cdata = g.vertex(c).data();
    const auto &rdata = g.vertex(r).data();
...
TEST_F(ListGraphTest, test_directed_astar_long)
{
    ...
    directed_graph.add_edge(simple_graph::Edge<float>(0, 1, dist(directed_graph, 0, 1)));
    directed_graph.add_edge(simple_graph::Edge<float>(1, 2, dist(directed_graph, 1, 2)));
    directed_graph.add_edge(simple_graph::Edge<float>(2, 3, dist(directed_graph, 2, 3)));
    directed_graph.add_edge(simple_graph::Edge<float>(3, 4, dist(directed_graph, 3, 4)));
    directed_graph.add_edge(simple_graph::Edge<float>(4, 7, dist(directed_graph, 4, 7)));
    directed_graph.add_edge(simple_graph::Edge<float>(0, 5, dist(directed_graph, 0, 5)));
    directed_graph.add_edge(simple_graph::Edge<float>(5, 6, dist(directed_graph, 5, 6)));
    directed_graph.add_edge(simple_graph::Edge<float>(6, 7, dist(directed_graph, 6, 7)));
